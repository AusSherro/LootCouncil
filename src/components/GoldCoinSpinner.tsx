        ...
        <div className={`inline-flex items-center justify-center ${className}`}>
            <div className={`${s.coin} coin-spin`}>
                <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* Dollar sign */}
                    <text x="20" y="25" textAnchor="middle" fill="var(--gold-dark)" fontWeight="700" fontSize="14" fontFamily="system-ui">$</text>
                    {/* Shine highlight */}
                    <ellipse cx="14" cy="13" rx="4" ry="6" fill="white" opacity="0.2" transform="rotate(-20, 14, 13)" />
                    <defs>
