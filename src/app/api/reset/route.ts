...
export async function DELETE(request: NextRequest) {
    ...
    try {
        // Delete in order of dependency (children first) - scoped to profile
        ...
        await prisma.assetLot.deleteMany({ where: { asset: { profileId } } });
        await prisma.asset.deleteMany({ where: { profileId } });
        ...
        await prisma.apiIntegration.deleteMany({ where: { profileId } });
